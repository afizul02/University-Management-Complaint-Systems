	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
			...
			<i class="fa-solid fa-bars text-primary"></i>
				...
				<li><?= $this->Html->link(__('List Department'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <div class="card-body text-body-secondary">
                ...
                <?php if (!empty($department->complaint)) : ?>
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($department->complaint as $complaint) : ?>
                        <tr>
